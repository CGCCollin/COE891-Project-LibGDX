 ...
 * @author mzechner */
public class CircleMutant implements Serializable, Shape2D {
	public float x, y;
	public float radius;
	...
	public CircleMutant (float x, float y, float radius) {
		this.x = x;
		this.y = y;
		this.radius = radius;
	}
	...
	public CircleMutant (Vector2 position, float radius) {
		this.x = position.x;
		this.y = position.y;
		this.radius = radius;
	}
	...
	public CircleMutant (Circle circle) {
		this.x = circle.x;
		this.y = circle.y;
	...
	public CircleMutant (Vector2 center, Vector2 edge) {
		this.x = center.x;
		this.y = center.y;
	...
	public boolean contains (CircleMutant c) {
	...
	public boolean overlaps (CircleMutant c) {
		float dx = x - c.x;
		float dy = y - c.y;
