...
/**
 * Encapsulates a 2D polygon defined by it's vertices relative to an origin
 * point (default of 0, 0).
 */
public class PolygonMutant implements Shape2D {
	 ...
	 *                 part of a point, and the following element
	 *                 representing the vertical part
	 * 
	 * @throws IllegalArgumentException if less than 6 elements, representing 3
	 *                                  points, are provided
	 */
	public PolygonMutant(float[] vertices) {
	...
	/**
	 * Returns the polygon's local vertices without scaling or rotation and without
	 * being offset by the polygon position.
	 */
	 ...
	 * and positional translations have been applied,
	...
	/**
	 * Sets the origin point to which all of the polygon's local vertices are
	 * relative to.
	 */
	...
	/**
	 * Sets the polygon's local vertices relative to the origin point, without any
	 * scaling, rotating or translations being
	 * applied.
	 * 
	 * @param vertices float array where every even element represents the
	 *                 x-coordinate of a vertex, and the proceeding element
	...
	/**
	 * Translates the polygon's position by the specified horizontal and vertical
	 * amounts.
	 */
	 ...
	 * 
	 * Note the returned Rectangle is cached in this polygon, and will be reused if
	 * this Polygon is changed.
	 * 
