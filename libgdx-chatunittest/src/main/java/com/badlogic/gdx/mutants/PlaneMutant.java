 ...
 */
public class PlaneMutant implements Serializable {
	private static final long serialVersionUID = -1240652082930747866L;

	/**
	 * Enum specifying on which side a point lies respective to the plane and it's
	 * normal. {@link PlaneSide#Front} is the side to
	 ...
	 */
	public PlaneMutant(Vector3 normal, float d) {
	 ...
	 */
	public PlaneMutant(Vector3 normal, Vector3 point) {
		this.normal.set(normal).nor();
	 ...
	 * be on the plane. The normal is calculated via a
	 ...
	 */
	public PlaneMutant(Vector3 point1, Vector3 point2, Vector3 point3) {
		set(point1, point2, point3);
	}

	/**
	 * Sets the plane normal and distance to the origin based on the three given
	 * points which are considered to be on the plane.
	 ...
	 * normal. PlaneSide.Front refers to the side the
	 ...
	 * direction vector as the direction a camera looks in.
	 * This method will return true if the front side of the plane determined by its
	 ...
	 */
	public void set(PlaneMutant plane) {
