...
/**
 * Encapsulates a 2D rectangle defined by its corner point in the bottom left
 * and its extents in x (width) and y (height).
 * 
 * @author badlogicgames@gmail.com
 */
public class RectangleMutant implements Serializable, Shape2D {
	/**
	 * Static temporary rectangle. Use with care! Use only when sure other code will
	 * not also use this.
	 */
	static public final RectangleMutant tmp = new RectangleMutant();

	/**
	 * Static temporary rectangle. Use with care! Use only when sure other code will
	 * not also use this.
	 */
	static public final RectangleMutant tmp2 = new RectangleMutant();
	...
	public RectangleMutant() {

	}

	/**
	 * Constructs a new rectangle with the given corner point in the bottom left and
	 * dimensions.
	 * 
	 ...
	 */
	public RectangleMutant(float x, float y, float width, float height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	 ...
	 */
	public RectangleMutant(RectangleMutant rect) {
		x = rect.x;
		y = rect.y;
		width = rect.width;
		height = rect.height;
	 ...
	 */
	public RectangleMutant set(float x, float y, float width, float height) {
		this.x = x;
		this.y = y;
		this.width = width;
		this.height = height;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setX(float x) {
		this.x = x;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setY(float y) {
		this.y = y;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setWidth(float width) {
		this.width = width;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setHeight(float height) {
		this.height = height;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setPosition(Vector2 position) {
		this.x = position.x;
		this.y = position.y;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setPosition(float x, float y) {
		this.x = x;
		this.y = y;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setSize(float width, float height) {
		this.width = width;
		this.height = height;
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant setSize(float sizeXY) {
		this.width = sizeXY;
		this.height = sizeXY;
	 ...
	 */
	public boolean contains(RectangleMutant rectangle) {
	 ...
	 */
	public boolean overlaps(RectangleMutant r) {
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant set(RectangleMutant rect) {
		this.x = rect.x;
		this.y = rect.y;
	...
	/**
	 * Merges this rectangle with the other rectangle. The rectangle should not have
	 * negative width or negative height.
	 * 
	 * @param rect the other rectangle
	 * @return this rectangle for chaining
	 */
	public RectangleMutant merge(RectangleMutant rect) {
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant merge(float x, float y) {
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant merge(Vector2 vec) {
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant merge(Vector2[] vecs) {
		float minX = x;
		float maxX = x + width;
		float minY = y;
		float maxY = y + height;
	 ...
	 * 
	 * @return the aspect ratio of this rectangle. Returns Float.NaN if height is 0
	 ...
	 */
	public RectangleMutant setCenter(float x, float y) {
	 ...
	 * @return this for chaining
	 */
	public RectangleMutant setCenter(Vector2 position) {
	 ...
	 * This scales and centers the rectangle to the
	 ...
	 * @see Scaling
	 */
	public RectangleMutant fitOutside(RectangleMutant rect) {
	 ...
	 * This scales and centers the rectangle to the
	 * other rectangle (e.g. Scaling a texture within a arbitrary cell without
	 * squeezing)
	 * 
	 ...
	 * @see Scaling
	 */
	public RectangleMutant fitInside(RectangleMutant rect) {
		float ratio = getAspectRatio();
	...
	/**
	 * Converts this {@code Rectangle} to a string in the format
	...
	/**
	 * Sets this {@code Rectangle} to the value represented by the specified string
	 ...
	 * @return this rectangle for chaining
	 */
	public RectangleMutant fromString(String v) {
		int s0 = v.indexOf(',', 1);
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RectangleMutant other = (RectangleMutant) obj;
